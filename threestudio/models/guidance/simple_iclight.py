...
@threestudio.register("dge-simple-iclight")
class IClight(DGEGuidance):
    @dataclass
    class Config(BaseObject.Config):
        cache_dir: Optional[str] = None
        ddim_scheduler_name_or_path: str = "/data/vjuicefs_ai_camera_ql/11184175/models/stable-diffusion-v1-4"
        ip2p_name_or_path: str = "/data/vjuicefs_ai_camera_ql/11184175/models/instruct-pix2pix"
    ...
    def configure(self) -> None:
        threestudio.info(f"Loading Simple IClight ...")
        self.weights_dtype = (
        ...
        threestudio.info(f"Loaded Simple ICLight!")
